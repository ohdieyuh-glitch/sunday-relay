 ...
 *
 * Relay ships its own entry page (`relay.html`). This repository contains no
 * Sunday Alcatraz application, so there is no second entry and no shared
 * alias into another product's source tree.
 */
