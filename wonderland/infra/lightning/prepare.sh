...
for g in verify-target-config.py verify-pixelstreaming-plugin.py verify-local-includes.py verify-look-table.py verify-docs.py verify-dog-proxy.py verify-hero-motif.py verify-hero-skyline.py verify-gameplay-classes.py verify-generator-classes.py verify-generator-dryrun.py; do
