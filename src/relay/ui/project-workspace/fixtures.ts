...
const implementing: WorkspaceFixture = {
  ...
  terminalEvents: [
    ...
    ev(
      'fx-ev-impl-c1a',
      '2026-07-22T11:58:05Z',
      'coding_agent',
      'agent_claim',
      'defining session types',
      'Adding AuthSession, TokenClaims, and AuthError to the module surface.',
      'MODIFY src/lib/auth.ts',
    ),
    ev(
      'fx-ev-impl-c1b',
      '2026-07-22T11:58:08Z',
      'coding_agent',
      'agent_claim',
      'writing signIn()',
      'signIn(credentials: Credentials): Promise<AuthSession> — validates input, then exchanges credentials for a signed session.',
      'MODIFY src/lib/auth.ts',
    ),
    ev(
      'fx-ev-impl-c1c',
      '2026-07-22T11:58:11Z',
      'coding_agent',
      'agent_claim',
      'writing verifySession()',
      'verifySession(token: string): TokenClaims | null — checks signature, issuer, and expiry before any claim is trusted.',
      'MODIFY src/lib/auth.ts',
    ),
    ev(
      'fx-ev-impl-c1d',
      '2026-07-22T11:58:14Z',
      'coding_agent',
      'agent_claim',
      'writing refreshToken()',
      'refreshToken(session: AuthSession): Promise<AuthSession> — single-flight refresh guarded by an in-flight promise.',
      'MODIFY src/lib/auth.ts',
    ),
    ev(
      'fx-ev-impl-c1e',
      '2026-07-22T11:58:16Z',
      'coding_agent',
      'agent_claim',
      'exporting the auth surface',
      'Named exports for signIn, verifySession, refreshToken, and AuthSession. 148 lines.',
      'MODIFY src/lib/auth.ts',
    ),
    ev(
      'fx-ev-impl-c2',
    ...
    ev(
      'fx-ev-impl-c2a',
      '2026-07-22T11:58:21Z',
      'coding_agent',
      'agent_claim',
      'wiring the auth import',
      "import { verifySession, type AuthSession } from './auth' — session slice added to RelayStoreState.",
      'MODIFY src/lib/relay-store.ts',
    ),
    ev(
      'fx-ev-impl-c2b',
      '2026-07-22T11:58:24Z',
      'coding_agent',
      'agent_claim',
      'adding store actions',
      'setSession(session: AuthSession), clearSession(), and a selectSession() selector.',
      'MODIFY src/lib/relay-store.ts',
    ),
    ev(
      'fx-ev-impl-c2c',
      '2026-07-22T11:58:27Z',
      'coding_agent',
      'agent_claim',
      'handling token expiry',
      'Expired claims clear the session instead of returning stale state.',
      'MODIFY src/lib/auth.ts',
    ),
    ev(
      'fx-ev-impl-c2d',
      '2026-07-22T11:58:30Z',
      'coding_agent',
      'agent_claim',
      'handling the refresh race',
      'Concurrent refreshToken() calls collapse into one request and share its result.',
      'MODIFY src/lib/auth.ts',
    ),
    ev(
      'fx-ev-impl-c2e',
      '2026-07-22T11:58:32Z',
      'coding_agent',
      'agent_claim',
      'handling invalid signatures',
      'verifySession() returns null for a malformed or unsigned token instead of throwing.',
      'MODIFY src/lib/auth.ts',
    ),
    ev(
      'fx-ev-impl-c2f',
      '2026-07-22T11:58:34Z',
      'coding_agent',
      'agent_claim',
      'writing tests',
      '12 cases: sign-in success, expired token, invalid signature, concurrent refresh, store wiring.',
    ...
    ev(
      'fx-ev-impl-c3a',
      '2026-07-22T11:58:44Z',
      'coding_agent',
      'agent_claim',
      'auth suite executing',
      'Sign-in, expiry, and invalid-signature cases returned expected values; concurrent refresh still running.',
      'RUN src/lib/auth.test.ts',
    ),
    ev(
      'fx-ev-impl-c4',
